...
class Program
{
    static void Main()
    {
        ...
        DisplaySubjectsTaughtByTeacher("John Doe");
    }
    ...
    static void FillData()
    {
        ...
        // Create students
        schoolData.Students.Add(SchoolFactory.CreateStudent("Alice Smith", "10A"));
        schoolData.Students.Add(SchoolFactory.CreateStudent("Bob Johnson", "10A"));
        schoolData.Students.Add(SchoolFactory.CreateStudent("Charlie Brown", "11B"));

        // Create teachers
        schoolData.Teachers.Add(SchoolFactory.CreateTeacher("John Doe", "10A"));
        schoolData.Teachers.Add(SchoolFactory.CreateTeacher("Jane Smith", "11B"));
